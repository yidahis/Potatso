...
size_t
pcre_regerror(int errcode, const regex_tt *preg, char *errbuf, size_t errbuf_size)
{
...
int
pcre_regcomp(regex_tt *preg, const char *pattern, int cflags)
{
const char *errorptr;
int erroffset;
int options = 0;
...
int
pcre_regexec(regex_tt *preg, const char *string, size_t nmatch,
